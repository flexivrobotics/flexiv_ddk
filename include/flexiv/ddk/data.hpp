 ...
 * @return Updated ostream instance.
 */
std::ostream& operator<<(std::ostream& ostream, const Manipulability& manipulability);
 ...
 * @return Updated ostream instance.
 */
std::ostream& operator<<(std::ostream& ostream, const CartesianCommands& cartesian_commands);
 ...
 * @return Updated ostream instance.
 */
std::ostream& operator<<(std::ostream& ostream, const JointCommands& joint_commands);
} /* namespace ddk */
} /* namespace flexiv */
